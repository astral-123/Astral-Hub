...
-- Ajouter une bordure rotative fine et visible partout
			...
			ResizeHandle.Image = "rbxassetid://10137941941" -- Icône à 3 traits
...
local function ChangeTheme(Theme)
		...
		Rayfield.Main.Topbar.BackgroundColor3 = SelectedTheme.Background
		Rayfield.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Background
					...
					if element.Name ~= "SectionSpacing" and element.Name ~= "Placeholder" then
						...
						elseif element.Name == 'Divider' then
							TweenService:Create(element.Divider, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {BackgroundTransparency = show and 0.85 or 1}):Play()
								...
								local bgTarget = element:GetAttribute("BackgroundTransparencyTarget") or ElementTransparency
...
local function Maximise()
	...
	TweenService:Create(dragBarCosmetic, TweenInfo.new(0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {BackgroundTransparency = 0.7}):Play()
		local TargetSize = Main:GetAttribute("SavedSize") or (useMobileSizing and UDim2.new(0, 500, 0, 275) or UDim2.new(0, 500, 0, 475))
		TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = TargetSize}):Play()
		TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, TargetSize.X.Offset, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			TweenService:Create(Button, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			TweenService:Create(Paragraph, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateInput(InputSettings)
			...
			TweenService:Create(Input, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			TweenService:Create(Dropdown, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			TweenService:Create(Keybind, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			TweenService:Create(Toggle, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
		...
		function Tab:CreateSlider(SliderSettings)
			...
			TweenService:Create(Slider, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = ElementTransparency}):Play()
